...
import { QUIZ_PROMPT } from "../utils/quizUtils";
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="flex justify-between">
            <button
              ...
              className="px-6 py-3 text-brand-600 !border-brand-500 rounded-lg hover:bg-brand-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              Previous
            </button>
